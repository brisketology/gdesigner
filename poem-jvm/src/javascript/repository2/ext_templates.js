...
Repository.Templates = {
		login :  new Ext.XTemplate(		'<div id="oryx_repository_header" onmouseover="this.className = \'mouseover\'" onmouseout="this.className = \'\'">'+
					        '<a href="http://grass-project.org" target="_blank">'+
						    '<img src="/backend/images/style/grass.small.png" id="grass_repository_logo" alt="Grass Logo" title="Grass"/>'+
					    '</a>'+
		...
		login2 : function () {
			tpl = new Ext.XTemplate('<div id="grass_repository_header"> <tpl if="isPublicUser"> PUBLIC </tpl><tpl if="!isPublicUser">  NOT PUBLIC </tpl></div>');
			//tpl.compile;
			return tpl;
		}
}